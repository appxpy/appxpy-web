    ...
    return (
        ...
        >
            ...
            <div
                ...
                className={`relative w-full sm:max-w-xl md:max-w-2xl h-full overflow-y-auto bg-[#0c0c0c] text-white border-l border-white/10 p-6 sm:p-10 transform transition-transform duration-500 ease-out ${
