...
const Page: FunctionComponent = (props) => {
  ...
  return (
      ...
      <main id="main" className={'absolute inset-0 font-inter font-normal opacity-80 p-6'}>
          <div className="relative h-full w-full box-border flex flex-col justify-between">
              ...
              <header
                  ...
                  <Logo size={40}/>
                  <a className="uppercase font-normal text-lg text-center w-40"
            ...
            <span
                className="relative uppercase font-normal text-sm opacity-70 md:text-lg text-start">
